    ...
    <el-row>
      <el-col :span="24">
        ...
        >
          ...
          <el-table-column prop="projectNo" label="项目号" align="center" min-width="7%"></el-table-column>
          ...
          <el-table-column prop="timeFrame" label="时间节点" align="center" min-width="7%"></el-table-column>
          ...
          <el-table-column prop="isUpdate" label="更新状态" align="center" min-width="5%"></el-table-column>
        </el-table>
      </el-col>
    </el-row>
    <!-- 分页组件---fzy -->
